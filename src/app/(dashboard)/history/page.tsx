...
async function getHistory() {
    ...
    let formatResult = experiments.map(experiment => {
        return {
            ...
            user_id: experiment?.user_id?.toString(),
            ...
            start_timestamp: experiment?.start_time ? new Date(experiment?.start_time).getTime() : 0,
            finish_timestamp: experiment?.finish_time ? new Date(experiment?.finish_time).getTime() : 0,
        }
    })
    return formatResult;
}
    ...
    return (
        <div className='container mx-auto'>
            <div className='flex flex-col gap-4'>
                <DashboardHeader heading="实验记录" text="查看用户实验记录">
                </DashboardHeader>
