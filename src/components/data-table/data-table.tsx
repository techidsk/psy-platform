                        ...
                        {table.getHeaderGroups().map((headerGroup) => (
                            <tr key={headerGroup.id}>
                                {headerGroup.headers.map((header) => (
                                    <th
                                        key={header.id}
                                        className="px-2 py-1.5 md:px-3 md:py-2 lg:px-4 lg:py-2 text-left text-xs font-medium text-base-content/50 tracking-wider"
                                    >
                            ...
                            {table.getRowModel().rows.map((row) => (
                                <tr key={row.id}>
                                    {row.getVisibleCells().map((cell) => (
                                        <td
                                            key={cell.id}
                                            className={`px-2 py-1 md:px-3 md:py-1.5 lg:px-4 lg:py-2 whitespace-nowrap text-xs md:text-sm text-base-content/70 ${
