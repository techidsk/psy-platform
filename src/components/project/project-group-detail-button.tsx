...
interface ProjectGroupDetailProps extends React.HTMLAttributes<HTMLButtonElement> {
...
export function ProjectGroupDetailButton({ experiment }: ProjectGroupDetailProps) {
